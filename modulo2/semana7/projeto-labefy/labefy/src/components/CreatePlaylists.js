    ...
    state = {
      ...
      render() {
        return (
          ...
          <Text>
            <h3>*Instruções</h3>
            <p>Acesse a sua biblioteca e clique na playlist que deseja adicionar uma música.</p>
            <p>Pode ser adicionada música do streaming que desejar (recomendamos Spotify).</p>
          </Text>
          </div>
