...
const PlaylistContainer = styled.div `
    height: 20rem;
    background: linear-gradient(#4d4d4d, #9198e5, #9198e5, #7478a5);
    display: flex;
...
export { PlaylistContainer, TrackContainer, TrackCard, LeftButtonContainer, ButtonMainContainer1, MainContainer2, TracksListContainer }