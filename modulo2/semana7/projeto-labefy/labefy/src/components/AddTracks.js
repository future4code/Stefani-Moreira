...
import { AddContainer, ContainerItems, MainContainer, Text } from './styles/StyledAddTracks'
...
export default class AddTracks extends React.Component {
    ...
    render() {
        return (
            ...
            <Text>
            <h4>*Instruções</h4>
            <p>No streaming da sua preferência, clique em compartilhar na música que deseja e então escolha a opção de incorporar faixa. Copie apenas a URL que for fornecida.</p>
                <details>
                    <summary>Spotify</summary>
                    <p> É necessário por "embed" antes do /track</p>
                    <p>Exemplo de link: https://open.spotify.com/embed/track/2ph6BRhGcUzc2W9wIulG5k?si=de5b70868c554d87</p>
                </details>
                <details>
                    <summary>Deezer</summary>
                    <p>É necessário por widget antes do nome .deezer e antes do tema escolhido para a música.</p>
                    <p>Exemplo de link: https://widget.deezer.com/widget/dark/track/908604612</p>
                </details>
                <details>
                    <summary>Apple Music</summary>
                    <p>É necessário por embed antes do .music</p>
                    <p>Exemplo de link: https://embed.music.apple.com/br/album/oh-my-god/1590035691?i=1590036031</p>
                </details>
            </Text>
            </ContainerItems>
